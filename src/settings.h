// clang-format off
	...
	*/
	...
	// (optinal) Neopixel
		...
		constexpr float s_warningLowVoltage = 3.14;                      // If battery-voltage is <= this value, a cyclic warning will be indicated by Neopixel (can be changed via GUI!)
		constexpr float s_warningCriticalVoltage = 3.0;                 // If battery-voltage is <= this value, assume battery near-empty. Set to 0V to disable.
		constexpr float s_voltageIndicatorLow = 3.1;                    // Lower range for Neopixel-voltage-indication (0 leds) (can be changed via GUI!)
		constexpr float s_voltageIndicatorHigh = 3.25;                   // Upper range for Neopixel-voltage-indication (all leds) (can be changed via GUI!)
	#endif
